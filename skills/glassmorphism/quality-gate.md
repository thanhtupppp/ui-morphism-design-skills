# Quality Gate - Glassmorphism

## Checklist chất lượng

### Nội dung bắt buộc
- [ ] Core Principles < 300 từ
- [ ] Design Tokens đầy đủ (color, spacing, radius, blur, border)
...
2. **Blur Effect**: `backdrop-filter: blur()` với giá trị 10-20px
3. **Border**: Border mỏng 1px với rgba(255,255,255,0.2-0.5)
4. **Background**: rgba(255,255,255,0.1-0.3) hoặc tương đương
5. **Shadow**: Box-shadow mềm để tạo depth
6. **Accessibility**: Contrast đủ, focus states rõ
