# Quality Gate - Claymorphism

## Checklist chất lượng

### Nội dung bắt buộc
- [ ] Core Principles < 300 từ
- [ ] Design Tokens đầy đủ (color, spacing, radius, shadow-inner, shadow-outer, highlight)
...
2. **Border Radius**: Large (16-32px) cho soft, clay-like look
3. **Inner Shadow**: `inset` shadow tạo depth bên trong
4. **Outer Shadow**: Regular shadow tạo elevation
5. **Highlight**: Light gradient/shadow ở top-left
6. **Colors**: Soft, pastel hoặc muted tones
7. **Accessibility**: Contrast đủ, focus states rõ, 3D effect vừa phải
