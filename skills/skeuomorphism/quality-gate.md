# Quality Gate - Skeuomorphism

## Checklist chất lượng

### Nội dung bắt buộc
- [ ] Core Principles < 300 từ
- [ ] Design Tokens đầy đủ (texture, color, shadow, highlight, material)
...
2. **Realistic Textures**: Wood, leather, metal, glass, paper, etc.
3. **Detailed Shadows**: Multi-layer shadows cho depth
4. **Highlights & Reflections**: Light source consistent
5. **Material Accuracy**: Texture looks like real material
6. **Accessibility**: Contrast đủ, textures không làm text khó đọc
